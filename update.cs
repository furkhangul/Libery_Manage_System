...
class Program
{
    ...
    static void Menu()
    {
        ...
        do
        {
            ...
            Console.WriteLine("| [5] Kitap Teslim Et         |");
            Console.WriteLine("| [6] Kullanıcı Listele       |");
            Console.WriteLine("| [7] Kitap Listele           |");
            Console.WriteLine("| [8] Kitap Dosyası Aç        |");
            Console.WriteLine("| [9] Kullanıcı Dosyasını Aç  |");
    ...
    static void KullaniciEkle()
    {
        ...
        Console.WriteLine("/_/ |_\\__,_/_/_/\\__,_/_/ /_/_/\\___/_/  /_____/_/|_/_/\\___/");
        Console.WriteLine("");
        Console.WriteLine("---------------------------------------------------------------------------------------------------------------------");
    ...
    {
        Console.Clear();
        Console.WriteLine("    __ __ _ __                 _   _     ___   _               _    __                       ");
        Console.WriteLine("   / //_/(_) /_____ _____     (_)_(_)___/ (_) (_)___  _____   | |  / /__  _________ ___  ___ ");
        Console.WriteLine("  / ,<  / / __/ __ `/ __ \\   / __ \\/ __  / / / / __ \\/ ___/   | | / / _ \\/ ___/ __ `__ \\/ _ \\");
        Console.WriteLine(" / /| |/ / /_/ /_/ / /_/ /  / /_/ / /_/ / /_/ / / / / /__     | |/ /  __/ /  / / / / / /  __/");
        Console.WriteLine("/_/ |_/_/\\__/\\__,_/ .___/   \\____/\\__,_/\\__,_/_/ /_/\\___/     |___/\\___/_/  /_/ /_/ /_/\\___/ ");
        Console.WriteLine("                 /_/                                /_)                                      ");
        Console.WriteLine("");
        Console.WriteLine("---------------------------------------------------------------------------------------------------------------------");
        Console.WriteLine("[*]Kitap ödünç verme bölümüne hoş geldiniz. Kullanıcıdan ID ve ISBN bilgilerini alarak kitabı ödünç verebilirsiniz.");
        Console.WriteLine("---------------------------------------------------------------------------------------------------------------------");
    ...
    {
        Console.Clear();
        Console.WriteLine("    __ __      ____                        __    _      __            _ ");
        Console.WriteLine("   / //_/_  __/ / /___ _____  _  ____ _   / /   (_)____/ /____  _____(_)");
        Console.WriteLine("  / ,< / / / / / / __ `/ __ \\/ / ___/ /  / /   / / ___/ __/ _ \\/ ___/ / ");
        Console.WriteLine(" / /| / /_/ / / / /_/ / / / / / /__/ /  / /___/ (__  ) /_/  __(__  ) /  ");
        Console.WriteLine("/_/ |_\\__,_/_/_/\\__,_/_/ /_/_/\\___/_/  /_____/_/____/\\__/\\___/____/_/   ");
        Console.WriteLine("----------------------------------------------------------------------------");
    ...
    {
        Console.Clear();
        Console.WriteLine("    __ __ _ __                 __    _      __            _ ");
        Console.WriteLine("   / //_/(_) /_____ _____     / /   (_)____/ /____  _____(_)");
        Console.WriteLine("  / ,<  / / __/ __ `/ __ \\   / /   / / ___/ __/ _ \\/ ___/ / ");
        Console.WriteLine(" / /| |/ / /_/ /_/ / /_/ /  / /___/ (__  ) /_/  __(__  ) /  ");
        Console.WriteLine("/_/ |_/_/\\__/\\__,_/ .___/  /_____/_/____/\\__/\\___/____/_/  ");
        Console.WriteLine("                 /_/                                        ");
        Console.WriteLine("---------------------------------------------------------------");
    ...
    {
        Console.Clear();
        Console.WriteLine("[*] Kitap dosyası açılıyor...");
    ...
    {
        Console.Clear();
        Console.WriteLine("[*] Kullanıcı dosyası açılıyor...");
